...
import com.diamondq.reactions.api.ParamBuilder;
...
public class ParamBuilderImpl<PT> extends CommonBuilderImpl<PT, ParamBuilder<PT>> implements ParamBuilder<PT> {
	...
	/**
	 * @see com.diamondq.reactions.api.ParamBuilder#valueByVariable(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.diamondq.reactions.api.ParamBuilder#valueByInput(java.util.function.Function)
	 */
