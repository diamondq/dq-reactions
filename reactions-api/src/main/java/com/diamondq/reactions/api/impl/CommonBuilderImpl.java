...
import com.diamondq.reactions.api.CommonBuilder;
...
public abstract class CommonBuilderImpl<T, AS extends CommonBuilder<T, AS>> implements CommonBuilder<T, AS> {
	...
	/**
	 * @see com.diamondq.reactions.api.CommonBuilder#isTransient()
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	/**
	 * @see com.diamondq.reactions.api.CommonBuilder#isPersistent()
	 */
	@SuppressWarnings("unchecked")
	@Override
